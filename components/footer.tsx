        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold tracking-tight">
              ...
              <span className="text-sky-500 dark:text-white">
                Inimitability
              </span>
            </h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Exploring the mathematical miracles and numerical patterns in the
              Holy Quran through academic research and collaboration.
            </p>
          ...
          <div>
            <h4 className="font-medium mb-4 text-base pb-1 border-b border-border/50">
              Quick Links
            </h4>
            <nav className="flex flex-col space-y-2.5">
              <Link
                href="/"
                className="text-sm text-muted-foreground hover:text-emerald-500 transition-colors inline-flex items-center"
              >
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-2.5">
              <a
                href="#"
                className="text-sm text-muted-foreground hover:text-emerald-500 transition-colors group inline-flex items-center"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500/70 mr-2 opacity-0 transform -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300"></span>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="aspect-square bg-white dark:bg-gray-800 rounded-full border-2 border-emerald-500/30 overflow-hidden flex items-center justify-center shadow-sm hover:shadow-md hover:border-emerald-500/70 transition-all duration-300 max-w-[80px] sm:max-w-full">
                <img
                  src="/images/white logo of dawa.png"
                  alt="Islamic Da'wa Academy"
                  className="w-[100%] h-[100%] object-contain p-1 " /* Increased size */
                  loading="lazy"
                />
              </div>
        ...
        <div className="mt-12 py-5 px-6 bg-background rounded-lg border border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">
              Akode Islamic Centre, Vazhakkad, Kerala
            </span>
          </div>
        </div>
